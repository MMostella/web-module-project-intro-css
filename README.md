...
- [1] Link your CSS stylesheet in the `index.html` and implement a CSS reset 
...
- [1] Apply box model properties (content, padding, margin, and border) to all content such that your webpage matches the design file. This will include at least:
...
- [1] Add CSS animations (hover, mouseover, etc.)
